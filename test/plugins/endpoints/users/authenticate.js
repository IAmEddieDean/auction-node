...
describe('POST /users/authenticate', function(){
  ...
  it('should pass authentication with a valid credentials', function(done){
    server.inject({method: 'POST', url: '/users/authenticate', credentials: {_id: 'b00000000000000000000002'}, payload: {email: 'bbb@bbb.com', password: 'bbb'}}, function(response){
